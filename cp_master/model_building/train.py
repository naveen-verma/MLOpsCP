...
Xtrain_path = "hf://datasets/nv185001/Realtime-Engine-Failure-Predictor/Xtrain.csv"
Xtest_path = "hf://datasets/nv185001/Realtime-Engine-Failure-Predictor/Xtest.csv"
ytrain_path = "hf://datasets/nv185001/Realtime-Engine-Failure-Predictor/ytrain.csv"
ytest_path = "hf://datasets/nv185001/Realtime-Engine-Failure-Predictor/ytest.csv"
...
# Save best model
joblib.dump(best_model, "best_engine_failure_predictor_model.joblib")
...
# create_repo("pred-model", repo_type="model", private=False)
api.upload_file(
    path_or_fileobj="best_engine_failure_predictor_model.joblib",
    path_in_repo="best_engine_failure_predictor_model.joblib",
    repo_id=repo_id,
    repo_type=repo_type,
)
